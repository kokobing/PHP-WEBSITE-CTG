  ...
  <tr>
    ...
    <td height="36" colspan="2"><table width="100%" height="36" border="0" cellpadding="0" cellspacing="0" background="../../inc/pics/nav.gif">
      ...
      <tr>
        ...
        <td width="439" style="color:#FFFFFF">&nbsp; &nbsp;&nbsp;</td>

        <td width="439"><div align="right" style="color:#FFFFFF">Your present position：<a href="/en/">HOME</a> <font color="#F5821F" style="font-size:14px">&gt;</font><font color="#FF0000"> &nbsp;Products</font></div></td>
        ...
        <table width="725" border="0" align="right" cellpadding="0" cellspacing="0" bgcolor="#FBFEFF" class="news">
          ...
          <tr>
            ...
            <td><table width="100%" height="12" border="0" cellpadding="0" cellspacing="0">
                  ...
                  height=28 style="color:#333333">&nbsp;Your present position&nbsp;>>&nbsp;Products                        </TD>

                        <TD width="102" style="color:#333333">ALL  <?=sizeof($arrprods);?> Products                        </TD>
              ...
              width=10></TD>
                              ...
                              <div id="productlist">
                                <table align=center width=170 border=0 cellspacing=2 cellpadding=0>
                                    ...
                                    <td colspan=2><TABLE align=center  border=0 cellPadding=0 cellSpacing=5>
                                      <TR>
                                        <TD align=middle ><TABLE width=160 height=120  bgcolor='#EEEEEE' align=center border=0 cellPadding=0 cellSpacing=0>
                                          <TR>
                                            <td valign='middle' style='text-decoration: underline;border: 1px solid #CCCCCC;'><div align=center><a href="/en/product/productinfo.php?pid=<?=$arrprods[$i][id_prodinfo]?>"><img src='/upload/product/<?=getproductpic($arrprods[$i][id_prodinfo]);?>' width='183' height='120' border='0'></a></div></td>
                                          </TR>
                                        </TABLE></TD>
                                      </TR>
                                    </TABLE>
                                  ...
                                  <tr>
                                    ...
                                    <td><a href="/en/product/productinfo.php?pid=<?=$arrprods[$i][id_prodinfo]?>"><?=$arrprods[$i][title]?></a></td>
                                  </tr>
                                  <tr>
                  ...
                  height=1 colspan="2"  align="right"> <a href="/en/">Home</a>&nbsp;</TD>
