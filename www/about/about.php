  ...
  <tr>
    ...
    <td height="36" colspan="2"><table width="100%" height="36" border="0" cellpadding="0" cellspacing="0" background="../inc/pics/nav.gif">
      ...
      <tr>
        ...
        <td width="112" align="center"><font color="#0D426F" style="font-size:14px"><strong>企业简介</strong></font></td>

        <td width="439" style="color:#FFFFFF">&nbsp; &nbsp;&nbsp;Products</td>

        <td width="439"><div align="right" style="color:#FFFFFF">您现在的位置：<a href="/">首页</a> <font color="#F5821F" style="font-size:14px">&gt;</font><font color="#FF0000"> &nbsp;企业简介</font></div></td>
